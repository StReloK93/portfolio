...
export function toon(Materials) {
    ...
    RimLightColor.value = Materials.rimLight;
    ...
    AmbientLightColor.value = Materials.ambient;
    ...
    DiffuseLightColor.value = Materials.diffuse;
    ...
    Color.target = 1;
    Color.value = Materials.specular;
    ...
    AddRimSpecDiffuseAmbient.output.connectTo(fragmentOutput.rgb);
...
export function toonImage() {
    ...
    textura.visibleOnFrame = false;
    textura.target = 3;
    textura.convertToGammaSpace = undefined;
    textura.convertToLinearSpace = false;
    textura.disableLevelMultiplication = false;
    textura.texture = new Texture('/images/test.jpg')
    // InputBlock
